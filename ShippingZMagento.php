...
define("SHIPPINGZMAGENTO_VERSION","4.0.8.6570");
	...
	function Fetch_DB_Orders($datefrom,$dateto)
	{
		...
		foreach ($orders_data as $order) 
		{
			...
			else
			{
				...
				{
					if($this->magento_orders[$counter]->order_info["Comments"]=="")
					$this->magento_orders[$counter]->order_info["Comments"]=$history->getComment();
					else
					$this->magento_orders[$counter]->order_info["Comments"].="~".$history->getComment();
